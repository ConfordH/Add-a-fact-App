...
async function loadFacts() {
  const res = await fetch(
    "https://xckxabreuwhqvoakjgbx.supabase.co/rest/v1/Facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhja3hhYnJldXdocXZvYWtqZ2J4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDA0NjYyNTMsImV4cCI6MjAxNjA0MjI1M30.mqWUkZuLr6rumCjn0zKDkmyVW8BQQAMYTsuYWqmAr_A",
      },
    }
  );
